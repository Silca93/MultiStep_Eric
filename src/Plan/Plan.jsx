...
export default function Plan({arcade, advanced, pro, clickNext2}) {
    ...
    let bgChange = () => {
      ref.current.className = "bg-gray-200 w-[9rem] h-[9rem] flex flex-col items-start justify-between pl-5 pt-4 border-solid border-gray-400 border-[1px] rounded-2xl"
    }
    ...
    <div className="w-full h-[25rem] flex flex-col gap-5 rounded-t-xl">
        ...
        <div className="TEST field w-full h-[10rem] flex justify-start items-start pl-[4rem]  gap-3">
            <div className="name flex flex-col gap-2">
                ...
                <div  className="BINGO w-[9rem] h-[9rem] flex flex-col items-start justify-between pl-5 pt-4 border-solid border-gray-400 border-[1px] rounded-2xl hover:ring-1 hover:ring-purple-600  focus:bg-gray-200 focus:ring-purple-600 focus:ring-2 " type="text" tabIndex="0">
                    <img src={arcade} alt=""  />
        ...
        <div className="w-full h-[5rem]  flex justify-center items-center">
            <div className="w-5/6 h-4/6 ml-5 bg-[#ecf3fd] flex justify-between items-center px-[4rem]">
                <p>Monthly</p>
                <input  type="checkbox" className="toggle [--tglbg:rgb(2,41,90)] bg-white hover:bg-white border-white " unchecked />
